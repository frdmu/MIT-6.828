...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
			...
			// Check whether there is a valid escape sequence like "			// \x1b[37;00m", the first 37 specifies the foreground c			// olor to white, the second 00 specifies the background
			// color to none
