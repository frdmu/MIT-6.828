    ...
    3986:	89 d3                	mov    %edx,%ebx
{
  ...
  while(--i >= 0)
    ...
    39f7:	89 f6                	mov    %esi,%esi
    39f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  neg = 0;
    ...
    3a34:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3a3a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
